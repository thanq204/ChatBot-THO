...
Đây là contract/schema tham khảo cho message đã chuẩn hóa. Runtime production ghi message vào bảng `operations_messages` của Supabase, không đọc file local thay cho bảng này.
...
- FAQ match đủ ngưỡng: trả câu trả lời đã duyệt từ `operations_faqs` và dừng; không gọi RAG/LLM.
