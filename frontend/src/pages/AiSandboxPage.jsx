...
import { PaperPlaneRight, Trash, CheckCircle, WarningCircle, EyeSlash, Hourglass } from "@phosphor-icons/react";
  ...
  return (
    ...
    >
      <div className="sandbox-result__header" style={{ borderColor: actionColor }}>
        ...
        <div className="sandbox-result__confidence">
          <span className="sandbox-result__confidence-value">
            <Counter value={Math.round(result.confidence * 100)} duration={0.7} />%
          </span>
      ...
      {result.agent_trace.length > 0 && (
        <div>
          <h3 className="sandbox-subheading">Quy trình xử lý</h3>
  ...
  return (
    <div className="page-grid">
      <div className="page-grid__row">
        <Card title="Mẫu thử nghiệm" className="span-6">
          <textarea
